...
% \usepackage{calc} % Pacote necessário para calcular a altura da logo
\usepackage{float} 
\usepackage{graphicx} 
\usepackage{hyperref} 
\usepackage{lipsum}
% \usepackage{caption}
\usepackage{formatcode}
\usepackage{setspace} % Para ajustar o espaçamento entre linhas
